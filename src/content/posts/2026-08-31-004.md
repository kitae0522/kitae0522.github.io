---
title: "홈서버 운영기 #4 — Docker 앱을 홈서버에 올리기"
...
<nav class="series-toc" aria-label="홈서버 운영기 목차">
  ...
  <ol>
    ...
    <li><a href="/posts/2026-08-31-004/" aria-current="page"><span>04</span> Docker 앱 올리기 <em>현재 글</em></a></li>
...
`lab` runner는 `ted-workshop` organization 공유 풀입니다. 저장소마다 runner를 새로 등록하지 않고, 같은 여섯 라벨을 붙인 private job이 유휴 슬롯을 사용합니다. Docker build가 필요한 job은 일반 job과 다르게 전용 socket을 명시해야 합니다. 다음은 핵심만 줄인 예시입니다.
...
## Tailscale Serve를 활용한 프라이빗 HTTPS 접근
